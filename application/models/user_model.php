...
class User_model extends CI_Model
{
    ...
    function create($email, $password, $firstname, $lastname, $phone, $spoken_language)
    {
        $this->email = $email;
    ...
    function update($email, $password, $phone, $spoken_language, $is_admin, $firstname, $lastname)
    {
        $this->email = $email;
        $this->password = md5($password);
        $this->phone = $phone;
